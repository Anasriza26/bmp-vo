...
const AdminStaff = () => {
    const [searchTerm, setSearchTerm] = useState("");
      ...
      const headers = [
        ...
        { label: "Contact Number", className: "" },
      ...
      const rows = [
        {
          cells: [
            { content: "Mohammed riza" }, // Name
            { content: "0754121698" }, // Wallet
            { content: "rizanas0526rza@gmail", className: "" }, // Amount
            { content: "Admin" }, // Reason
          ],
          actions: (
    ...
    <>
      <section className="CommonHeader">
        <CommonHeader
          ...
          subtitle="View, edit and delete staff details."
        />
      </section>
