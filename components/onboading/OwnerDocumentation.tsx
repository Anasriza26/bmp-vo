...
const ownerdocumentation = () => {
  ...
  const handleNext = (e: React.FormEvent<HTMLFormElement> | React.MouseEvent<HTMLButtonElement>) => {
    e.preventDefault();
    if (validateForm()) {
  ...
  const renderFileUpload = (fieldName: FormField, label: string, id: string) => {
      ...
      <main>
        ...
        <div className="flex justify-center mt-[40px]">
          ...
          >
            ...
            {renderFileUpload('businessRegistration', 'Business Registration Document', 'business-registration')}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div>
              <button
                type="button"
                onClick={handleNext}
                className="w-full border border-gray-300 rounded-md py-2 text-white bg-btncolor hover:bg-opacity-90 transition-colors"
              >
                Next
              </button>
            </div>
